                                            ...
                                            <tbody>
												...
												foreach ($approve as $a) :
													...
													$x = $this->Mproduk->getquery("SELECT *
																							...
																							WHERE bk.id_user = '$a->id_user'");

													$s = $this->Mproduk->getquery("SELECT *
																							FROM barang_keluar bk
																							INNER JOIN tb_status s
																							ON s.id_status = bk.id_status
																							WHERE bk.id_user = '$a->id_user'");
                                                ...
                                                <tr>
                                                    ...
                                                    <td><b>Nama Barang&nbsp;:</b> <?= $x->nama_produk ?>
                                                        <br><b>Keterangan &nbsp;&nbsp;&nbsp; :</b> <?= $a->keterangan ?>
                                                        <br><b>Jumlah Permintaan &nbsp;&nbsp; :</b>
                                                        <?= $a->qty_request ?>
                                                        <br><b>Jumlah disetujui<span style="margin-left: 10px;">
                                                                :</span></b>
                                                        <?= $a->qty ?>
                                                    ...
                                                    <td> <?php if ($a->id_status == 0) {
                                                        ...
                                                        <center>
                                                            <a href="#" class="badge badge-danger"><i
                                                                ...
                                                                Di Tolak<span class="badge badge-light"></span>
                                                                <span class="sr-only">unread messages</span></a>
                                                        </center>
                                                    ...
                                                    <td>
                                                        <center>
                                                            <a type="submit"
                                                                href="<?= base_url('Home/edit_approve/' . $a->id_bk) ?>"

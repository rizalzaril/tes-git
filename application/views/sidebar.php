				   ...
				   with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo base_url('Home/Data_produk'); ?>" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url('Home/items_out') ?>" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url('Home/items_in') ?>" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="pages/forms/editors.html" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p style="color: white;">Barang Keluar</p>
                                </a>
                            </li>
                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            <i class="nav-icon fas fa-apartment"></i>
                            <p style="color: white;">
                                Project
                                <i class="fas fa-angle-left right"></i>
                            </p>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?= base_url('Relokasi/Data_inventory'); ?>" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p style="color: white;">Materials & Equipment</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="pages/forms/validation.html" class="nav-link">

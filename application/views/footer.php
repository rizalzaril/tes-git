...
<!-- <strong>Copyright &copy; 2014-2021 <a href="https://adminlte.io">RIZAL LIYAN SYAH</a>.</strong>
    All rights reserved. -->
...
<script
    src="<?php echo base_url() ?>/assets/templates/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js">
</script>
<!-- Summernote -->
<script src="<?php echo base_url() ?>/assets/templates/plugins/summernote/summernote-bs4.min.js"></script>
<!-- overlayScrollbars -->
<script src="<?php echo base_url() ?>/assets/templates/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js">
</script>
<!-- AdminLTE App -->
...
<script src="<?php echo base_url() ?>/assets/sweet_alert/dist/myscript.js"></script>
<script>
$(function() {
    $("#example1").DataTable({
        "responsive": true,

                                    ...
                                    <div class="table table-striped table-responsive-lg">
                                        <table id="mydatatable"
                                            ...
                                            <button type="button" class="btn btn-primary" style="margin-bottom: 20px;"
                                                data-toggle="modal" data-target="#Modal_company" data-whatever="@mdo"><i
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?= $no; ?></td>
                                                    <td><?= $c->kode_perusahaan ?></td>
                                                    <td><?= $c->nama_perusahaan ?></td>
                                                    <td><?= $c->telepon ?></td>
                                                    <td><?= $c->alamat ?></td>
                                                    <td><a href="<?= base_url(); ?>Support/hapus_data_company/<?= $c->id_perusahaan ?>"
                                                            class="btn btn-danger tombol-hapus">
                                                            <i class="fas fa-trash"></i>
                                                        </a>

                                                        <a href="<?= base_url(); ?>Home/edit/<?= $c->id_perusahaan ?>"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="container">
                            <form action="<?= base_url('Support/save_perusahaan'); ?>" method="POST">

                                <div class="form-group">
                                    <label for="cari">Kode Perusahaan</label>
                                    <input type="text" class="form-control" id="kodeperusahaan" name="kodeperusahaan"
                                        value="PRS<?php echo sprintf("%04s", $kode_perusahaan) ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="cari">Nama Perusahaan</label>
                                    <input type="text" class="form-control" id="" name="namaperusahaan" value="">
                                </div>
